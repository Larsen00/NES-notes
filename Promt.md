...
3. Provide **only notes**, nothing else:
    ...
    - No instructions like “say next when you’re ready”
        
    - I will always type “next” when I want you to move on.
        
4. If the slide contains **math or formulas**, format them in Obsidian-friendly Markdown, using `$$ ... $$` or `$ ... $` as appropriate.  
    If the slide **does not** show any math, don’t invent extra math.
    
5. If **two or more things are being described or compared**, even across multiple slides, include a **table** comparing them when it makes sense.
    
6. Assume my general knowledge about networked embedded systems is **low**, but I have an **exam soon where these slides are the main source**.  
    So:
